...
const Header=()=>{
  ...
  <h1 className="display-4" >
   ...
   <Link to={"/products"} id="shop" > <svg xmlns="http://www.w3.org/2000/svg" width="50" height="60" fill="currentColor" className="bi bi-star" viewBox="0 0 16 16">
  ...
  <p className="lead">This is a simple E-ommerce website,where you can purchase the products like clothing
